...
- legacy app は serial/storage/RTC/E820 provider を app 側に直接 link し、`legacy_platform_ops` を自前で構成する。stage3 からの platform callback table は互換のため ABI に残っているが、legacy app runtime では使わない。
