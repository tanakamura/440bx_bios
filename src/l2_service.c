...
#define L2SVC __attribute__((section(".l2svc"), noinline, used))
#define L2SVC_ENTRY __attribute__((section(".l2svc.entry"), noinline, used))
...
L2SVC_ENTRY int l2_enable_service(struct l2_status* status) {
    unsigned int bbl;
    int l2r0;
    int l2r2;
    int l2r3;
