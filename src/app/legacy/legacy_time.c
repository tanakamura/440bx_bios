...
void legacy_int1a_service(struct rm_int13_frame* f,
    ...
    switch ((unsigned char)(f->ax >> 8)) {
        ...
        case 0x02u: {
            ...
            if (bios_rtc_read_time_bcd(&hour_bcd, &min_bcd, &sec_bcd) != 0) {
                hour_bcd = 0x12u;
                min_bcd = 0x00u;
                sec_bcd = 0x00u;
            }
        ...
        case 0x04u: {
            ...
            if (bios_rtc_read_date_bcd(&year_bcd, &mon_bcd, &day_bcd) != 0) {
                year_bcd = 0x26u;
                mon_bcd = 0x05u;
                day_bcd = 0x08u;
            }
        ...
        case 0x03u:
            if (bios_rtc_set_time_bcd((unsigned char)(f->cx >> 8),
                                      (unsigned char)f->cx,
            ...
            return;
        case 0x05u:
            if (bios_rtc_set_date_bcd((unsigned char)f->cx,
