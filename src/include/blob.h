...
#define BLOB_FLAG_LZ4_STREAM 0x00000002u
#define BLOB_FLAG_HAS_LOAD_ADDR 0x00000004u
#define BLOB_FLAG_KNOWN (BLOB_FLAG_LZ4_STREAM | BLOB_FLAG_HAS_LOAD_ADDR)
...
#define STAGE15_LOAD_LINEAR 0x00060000u
#define STAGE15_LOAD_CAPACITY 0x00010000u
...
#define APP_SLOT_LOAD_LINEAR 0x000f0000u
#define APP_SLOT_LOAD_CAPACITY 0x00010000u
